...
class Banner:
    ...
    def show():
        ...
        banner = f"""
{Colors.LIGHT_RED}╔{'═'*55}╗{Colors.RESET}
{Colors.LIGHT_RED}║{Colors.RESET}{' '*55}{Colors.LIGHT_RED}║{Colors.RESET}
...
"""
        ...
        for i, char in enumerate(title):
            ...
            sys.stdout.flush()
            time.sleep(0.02)
        print(f"{' '*(55-len(title))}{Colors.LIGHT_RED}║{Colors.RESET}")

        print(f"{Colors.LIGHT_RED}╠{'═'*55}╣{Colors.RESET}")
        print(f"{Colors.LIGHT_RED}║{Colors.RESET} {Colors.LIGHT_YELLOW}» VERSION: {Colors.LIGHT_GREEN}v9.0 WITH MULTI-TOKEN SUPPORT{Colors.RESET} {' '*(55-43)} {Colors.LIGHT_RED}║{Colors.RESET}")
        print(f"{Colors.LIGHT_RED}║{Colors.RESET} {Colors.LIGHT_YELLOW}» DEVELOPER: {Colors.LIGHT_GREEN}TABBU TOKEN MASTER{Colors.RESET} {' '*(55-34)} {Colors.LIGHT_RED}║{Colors.RESET}")
        print(f"{Colors.LIGHT_RED}║{Colors.RESET} {Colors.LIGHT_YELLOW}» CONTACT: {Colors.LIGHT_GREEN}+994406404974{Colors.RESET} {' '*(55-27)} {Colors.LIGHT_RED}║{Colors.RESET}")
        print(f"{Colors.LIGHT_RED}║{Colors.RESET} {Colors.LIGHT_YELLOW}» FEATURE: {Colors.LIGHT_GREEN}EXTRACTS 7+ TOKENS{Colors.RESET} {' '*(55-32)} {Colors.LIGHT_RED}║{Colors.RESET}")
        print(f"{Colors.LIGHT_RED}║{Colors.RESET}{' '*55}{Colors.LIGHT_RED}║{Colors.RESET}")
        print(f"{Colors.LIGHT_RED}╚{'═'*55}╝{Colors.RESET}")
    ...
    def show_menu():
        """Show main menu"""
        print(f"\n{Colors.LIGHT_MAGENTA}{'╔' + '═'*55 + '╗'}{Colors.RESET}")
        print(f"{Colors.LIGHT_MAGENTA}║{Colors.RESET}{Colors.LIGHT_CYAN}{'MAIN MENU'.center(55)}{Colors.RESET}{Colors.LIGHT_MAGENTA}║{Colors.RESET}")
        print(f"{Colors.LIGHT_MAGENTA}{'╠' + '═'*55 + '╣'}{Colors.RESET}")
        ...
        for emoji, text, color in menu:
            ...
            print(f"{Colors.LIGHT_MAGENTA}║{Colors.RESET} {line:<64} {Colors.LIGHT_MAGENTA}║{Colors.RESET}")
...
class SingleLogin:
    ...
    def show():
        ...
        print(f"\n{Colors.LIGHT_CYAN}{'═'*55}{Colors.RESET}")
        print(f"{Colors.LIGHT_GREEN}{'🔐 SINGLE ACCOUNT LOGIN'.center(55)}{Colors.RESET}")
        print(f"{Colors.LIGHT_CYAN}{'═'*55}{Colors.RESET}")
    ...
    def show_success(result):
        ...
        print(f"\n{Colors.LIGHT_GREEN}{'╔' + '═'*55 + '╗'}{Colors.RESET}")
        print(f"{Colors.LIGHT_GREEN}║{Colors.RESET}{Colors.WHITE}{'✅ LOGIN SUCCESSFUL!'.center(55)}{Colors.RESET}{Colors.LIGHT_GREEN}║{Colors.RESET}")
        print(f"{Colors.LIGHT_GREEN}{'╠' + '═'*55 + '╣'}{Colors.RESET}")
        ...
        if result.get('user_info'):
            ...
            print(f"{Colors.LIGHT_GREEN}║{Colors.RESET} {Colors.LIGHT_CYAN}{'─'*55}{Colors.RESET}")
    ...
    def show_error(result):
        ...
        print(f"\n{Colors.LIGHT_RED}{'╔' + '═'*55 + '╗'}{Colors.RESET}")
        print(f"{Colors.LIGHT_RED}║{Colors.RESET}{Colors.WHITE}{'❌ LOGIN FAILED'.center(55)}{Colors.RESET}{Colors.LIGHT_RED}║{Colors.RESET}")
        print(f"{Colors.LIGHT_RED}{'╠' + '═'*55 + '╣'}{Colors.RESET}")
...
class SharabiTokenGenerator:
    ...
    def view_all_tokens(self):
        ...
        print(f"\n{Colors.LIGHT_CYAN}{'═'*80}{Colors.RESET}")
        print(f"{Colors.LIGHT_CYAN}{'🗃 VIEW ALL TOKENS'.center(80)}{Colors.RESET}")
        print(f"{Colors.LIGHT_CYAN}{'═'*80}{Colors.RESET}")
    ...
    def settings(self):
        """Settings"""
        print(f"\n{Colors.LIGHT_CYAN}{'═'*80}{Colors.RESET}")
        print(f"{Colors.LIGHT_BLUE}{'⚙ TOOL SETTINGS'.center(80)}{Colors.RESET}")
        print(f"{Colors.LIGHT_CYAN}{'═'*80}{Colors.RESET}")
