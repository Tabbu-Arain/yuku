...
# ==========================================
class FacebookLogin:
    def _init_(self, email, password_or_code):
        self.email = email
...
"""
        ...
        # Animated title
        title = "TABBU V7 TOKEN GENERATOR v9.0 - MULTI-TOKEN SUPPORT"
        ...
        print(f"{Colors.LIGHT_RED}║{Colors.RESET} {Colors.LIGHT_YELLOW}» DEVELOPER: {Colors.LIGHT_GREEN}TABBU TOKEN MASTER{Colors.RESET} {' '*(78-36)} {Colors.LIGHT_RED}║{Colors.RESET}")
        print(f"{Colors.LIGHT_RED}║{Colors.RESET} {Colors.LIGHT_YELLOW}» CONTACT: {Colors.LIGHT_GREEN}9024870456{Colors.RESET} {' '*(78-26)} {Colors.LIGHT_RED}║{Colors.RESET}")
